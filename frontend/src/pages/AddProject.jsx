          ...
          <Col xs={12}>
            <Stack gap={3}>
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  updateRegisterInfo({ ...projectInfo, type: e.target.value })
                }
              />
              <Form.Control
                type="text"
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  updateRegisterInfo({ ...projectInfo, status: e.target.value })
                }
              />
              <Form.Control
                type="text"
                ...
                onChange={(e) =>
                  updateRegisterInfo({ ...projectInfo, impact: e.target.value })
                }
              />
